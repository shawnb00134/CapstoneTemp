...
public class DeleteTests
{
    ...
    public void DeletePackageValid()
    {
        ...
        var result = this.packageController.DeletePackage(package, userId, "").Result;
        Assert.IsNotNull(result);
        Assert.IsInstanceOf<OkResult>(result);
    }

    [Test]
    public void DeletePackagePackageNotSetCorrectly()
    {
        var userId = 1;
        var package = new Package
        {
            ...
            UpdatedAt = null,
            UpdatedBy = null,
            IsDeleted = false //Normally this is true to delete the package
        };
        var result = this.packageController.DeletePackage(package, userId, "").Result;
    ...
    [Test]
    public void DeletePackageInvalidUserId()
    {
        var userId = 0;
        var package = new Package
        {
    ...
    [Test]
    public void DeletePackageFolderValid()
    {
        var userId = 1;
        ...
        var result = this.packageController.DeletePackageFolder(packageFolder, userId, "").Result;
        Assert.IsNotNull(result);
        Assert.IsInstanceOf<OkObjectResult>(result);
    }

    [Test]
    public void DeletePackageFolderInvalidUserId()
    {
        var userId = 0;
        var packageFolder = new PackageFolder
        {
    ...
    [Test]
    public void DeletePackageFolderInvalidPackageFolder()
    {
        var userId = 1;
        var result = this.packageController.DeletePackageFolder(null, userId, "").Result;
        Assert.IsInstanceOf<BadRequestObjectResult>(result);
    }
