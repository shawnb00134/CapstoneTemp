...
[TestFixture]
public class GetByLibraryFolderIdDisplayInfoTests
{
    #region Data members
    ...
    {
        var elements = await this.repository?.GetByLibraryFolderIdDisplayInfo(1)!;
    ...
    {
        var elements = await this.repository?.GetByLibraryFolderIdDisplayInfo(3)!;
