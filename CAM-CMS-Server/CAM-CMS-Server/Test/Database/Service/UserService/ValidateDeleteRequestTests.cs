...
[TestFixture]
public class ValidateDeleteRequestTests
{
    #region Data members
    ...
    {
        Assert.True(await this.service.ValidateDeleteRequest(1, 3, 1));
    }

    [Test]
    public async Task ValidateValidOrganizationRequest()
    {
        Assert.True(await this.service.ValidateDeleteRequest(1, 1, 3));
    }

    [Test]
    public async Task ValidateValidSystemRequest()
    {
        Assert.True(await this.service.ValidateDeleteRequest(1, 1, 1));
    }

    [Test]
    public async Task ValidateInvalidLibraryFolderRequest()
    {
        Assert.False(await this.service.ValidateDeleteRequest(2, 3, 1));
    }

    [Test]
    public async Task ValidateInvalidOrganizationRequest()
    {
        Assert.False(await this.service.ValidateDeleteRequest(2, 1, 3));
    }

    [Test]
    public async Task ValidateInvalidSystemRequest()
    {
        Assert.False(await this.service.ValidateDeleteRequest(2, 1, 1));
    }

    [Test]
    public void ValidateInvalidUserId()
    {
        Assert.ThrowsAsync<ArgumentOutOfRangeException>(async () => await this.service.ValidateDeleteRequest(0, 1, 1));
    }

    [Test]
    public void ValidateInvalidLibraryId()
    {
        Assert.ThrowsAsync<ArgumentOutOfRangeException>(async () => await this.service.ValidateDeleteRequest(1, 0, 1));
    }

    [Test]
    public void ValidateInvalidOrganizationId()
    {
        Assert.ThrowsAsync<ArgumentOutOfRangeException>(async () => await this.service.ValidateDeleteRequest(1, 1, 0));
    }
